...
contract ContractTemplate2 {
    ...
    IERC20 public token;
    // Mapping from NFT(ERC721P) address -> account -> claimed
    mapping(address => mapping(address => bool)) public claimRecords;
    ...
    function claim(address nft, uint tokenId, bytes memory extraVerify) external {
        ...
        require(!claimRecords[nft][msg.sender], "already claimed");
        ...
        claimRecords[nft][msg.sender] = true;
        claimed += 1;
